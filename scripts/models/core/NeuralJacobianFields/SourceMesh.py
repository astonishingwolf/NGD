...
class SourceMesh:
    ...
    def __init_from_mesh_data(self, make_new =  False):
        assert self.mesh_processor is not None
        self.mesh_processor.prepare_differential_operators_for_use(self.__ttype, make_new = make_new) #call 1
    ...
    def load(self, source_v=None, source_f=None, make_new = False):
        ...
        # 
        self.__init_from_mesh_data(make_new = make_new)
