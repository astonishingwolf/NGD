...
class AlphaRenderer(NormalsRenderer):
    ...
    * shillouette
    ...
    def forward(self,
        ...
        # max_depth = depth.max()
        # print(f"The depth information {depth[:5,...]}")
        ...
        col = torch.concat((diffuse, depth, alpha),dim=-1) #C,H,W,5
        col = dr.antialias(col, rast_out, verts_clip, faces) #C,H,W,5
        return col, depth_info, pixel_normals_view,rast_out.clone()
    ...
    def forward_w_col(self,
        ...
        # save_image(verts_col[0].permute(2,0,1), 'output_png.png')
...
class GTInitializer:
    ...
    def render(self, modified_verts, modified_faces, renderer: AlphaRenderer):
        ...
        target_images, target_depth_info, target_normals, rast_out = \
